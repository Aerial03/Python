...
True: 0이 아닌 수, 문자, 데이터가 있는 리스트, 튜플, 집합, 사전
False: 0, "", 데이터가 없는 리스트, 튜플, 집합, 사전
'''
...
#     print('{}년 2월 마지막 일은 29입니다.'.format(year))
# elif month in day1:
#     print(('{}년 {}월 마지막 일은 31입니다.'.format(year, month)))
# elif month in day2:
#     print(('{}년 {}월 마지막 일은 30입니다.'.format(year, month)))
# elif month < 1 or month >= 13:
#     print('1월과 12월까지만 입력이 가능합니다.')
# else:
#     print('{}년 2월 마지막 일은 28입니다.'.format(year))
...
# if year%4 == 0 and year%100 !=0 or year%400 == 0:
#     print('{}년 {}월 마지막 일은 {}입니다.'.format(year, month, year_month[-1]))
# else:
#     print('{}년 {}월 마지막 일은 {}입니다.'.format(year, month, leap_year_month[-1]))
...
# else:
#     if year%4 == 0 and year%100 !=0 or year%400 == 0:
#         print(('{}년 {}월 마지막 일은 29입니다.'.format(year, month)))
#     else:
#         print(('{}년 {}월 마지막 일은 28입니다.'.format(year, month)))
...
for data in tmpLst:
    if data.isupper():
        lst.append(data)
print(' ', lst)
#lst = [data for data in tmpLst if data.isupper()]

tmpLst = ['greeting.py', 'ex01.py', 'intro.hwp', 'bigdata.doc', 'machine_learning.jpy']
lst = []
for data in range(len(tmpLst)):
    print(tmpLst[data].split('.')[0])